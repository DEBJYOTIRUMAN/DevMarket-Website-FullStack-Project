...
import image1 from '../images/antiviruspage1.jpg';
import image2 from '../images/antiviruspage2.jpg';
import image3 from '../images/antiviruspage3.jpg';
import image4 from '../images/antiviruspage4.jpg';
import image5 from '../images/antiviruspage5.jpg';
const Antivirus = () => {
    ...
    return (
        <>
            ...
            <h3 className="text-center my-4 fw-bold">Antivirus & Security</h3>
